...
module.exports = function(ServerlessPlugin) {
  // Always pass in the ServerlessPlugin Class
  ...
  class ServerlessPluginBoilerplate extends ServerlessPlugin {
    ...
    registerActions() {
      this.S.addAction(this._customAction.bind(this), {
        ...
        options: [
          {
            // These must be specified in the CLI like this "-option true" or "-o true"
            option: "option",
            shortcut: "o",
    ...
    _hookPre(evt) {
      ...
      return new BbPromise(function(resolve, reject) {
        console.log("-------------------");
        console.log(
          'YOUR SERVERLESS PLUGIN\'S CUSTOM "PRE" HOOK HAS RUN BEFORE "FunctionRunLambdaNodeJs"'
        );
        console.log("-------------------");
    ...
    _hookPost(evt) {
      ...
      return new BbPromise(function(resolve, reject) {
        console.log("-------------------");
        console.log(
          'YOUR SERVERLESS PLUGIN\'S CUSTOM "POST" HOOK HAS RUN AFTER "FunctionRunLambdaNodeJs"'
        );
        console.log("-------------------");
